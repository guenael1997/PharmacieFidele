<script setup>
    ...
    import ArticleQueryFormVue from '../components/ArticleQueryForm.vue';
</script>

<template>
    <div class="text-start m-5">
        <button type="button" class="btn btn-success btn-lg rounded-pill py-2 px-5" data-bs-toggle="modal" data-bs-target="#AddArticle">
    ...
    <div class="m-4 p-4 border border-4 rounded">
        ...
        <ArticleQueryFormVue v-for="Article in Articles" :Article="Article" />
    </div>
    <div class="text-start m-5">
        <button type="button" class="btn btn-success btn-lg rounded-pill py-2 px-5" data-bs-toggle="modal" data-bs-target="#AddArticle">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
